...
export function Navbar() {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-[100] px-4 md:px-6 py-4 flex justify-center pointer-events-none">
        <div className="glass px-4 md:px-6 py-3 rounded-full flex items-center gap-4 md:gap-8 border border-white/10 max-w-[1200px] w-full justify-between pointer-events-auto">
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="flex flex-col gap-4 text-xl font-bold">
              ...
              <Link href="/cutoffs" onClick={closeMenu} className="py-3 border-b border-white/10 hover:text-primary transition-colors">Explore Cutoffs</Link>
